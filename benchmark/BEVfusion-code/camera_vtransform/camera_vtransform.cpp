...
int main(int argc, char** argv) {
    ...
    long long int time_end = InterChiplet::readSync(timeNow, 3, 3, idX, idY, 6 * 32 * 88 * 80 * sizeof(float), 0);
    std::cout<<"--------------------------------"<<std::endl;
    ...
    time_end = InterChiplet::writeSync(time_end, idX, idY, 3, 3, 1 * 80 * 180 * 180 * sizeof(float), 0);
    return 0;
}